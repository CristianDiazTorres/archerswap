...
describe('utils', () => {
  describe('#getBlockscoutLink', () => {
    it('correct for tx', () => {

      expect(getSnowtraceLink(1, 'abc', 'transaction')).toEqual('https://blockscout.com/astar/tx/abc')
    })
    it('correct for token', () => {
      expect(getSnowtraceLink(1, 'abc', 'token')).toEqual('https://blockscout.com/astar/token/abc')
    })
    it('correct for address', () => {
      expect(getSnowtraceLink(1, 'abc', 'address')).toEqual('https://blockscout.com/astar/address/abc')
    })
    it('unrecognized chain id defaults to mainnet', () => {
      expect(getSnowtraceLink(2, 'abc', 'address')).toEqual('https://blockscout.com/astar/address/abc')
    })
    it('ropsten', () => {
      expect(getSnowtraceLink(3, 'abc', 'address')).toEqual('https://blockscout.com/astar/address/abc')
    })
    it('enum', () => {
      expect(getSnowtraceLink(ChainId.BSCTESTNET, 'abc', 'address')).toEqual('https://blockscout.com/astar/address/abc')
    })
  })
