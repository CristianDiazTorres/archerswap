...
import { Heading, Card, CardBody, Flex, ArrowForwardIcon, Skeleton } from 'archerswap-uikit'
    ...
    const apys = farmsLP
      ...
      .map((farm) => {
        if (farm.lpTotalInQuoteToken && prices) {
          ...
          return getFarmApy(farm.poolWeight, bowPrice, totalLiquidity, farm.tokenPerSecond)
        }
        return null
      })
